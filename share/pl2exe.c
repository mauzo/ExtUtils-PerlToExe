...
/* 
 * This file has substitutions made in it be ExtUtils::PerlToExe. All
 * the $foo are magic, as is the / *$ ... * / comment.
 */
...
static char         argv_buf[$len] = $argv_buf;
...
)
{
    ...
    my_argv[$n] = argv_buf + $ptr; /*$my_argv_init*/
