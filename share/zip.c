 ...
 * contents of zip.xs. Do not edit this file, edit zip.xs instead.
 *
...
XS(XS_ex__lib__zip_new); /* prototype to pass -Wmissing-prototypes */
XS(XS_ex__lib__zip_new)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "ex::lib::zip::new", "class, file");
...
XS(XS_ex__lib__zip_name); /* prototype to pass -Wmissing-prototypes */
XS(XS_ex__lib__zip_name)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "ex::lib::zip::name", "self");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	LIBZIB_OBJ *	self;
	SV *	RETVAL;
...
XS(XS_ex__lib__zip_INC); /* prototype to pass -Wmissing-prototypes */
XS(XS_ex__lib__zip_INC)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "ex::lib::zip::INC", "self, file");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	LIBZIB_OBJ *	self;
	SV *	file = ST(1);
...
#line 697 "zip.c"
	ST(0) = sv_newmortal();
	{
	    GV *gv = newGVgen("ex::lib::zip");
	    if ( do_open(gv, "+<&", 3, FALSE, 0, 0, RETVAL) )
		sv_setsv(ST(0), sv_bless(newRV((SV*)gv), gv_stashpv("ex::lib::zip",1)));
	    else
		ST(0) = &PL_sv_undef;
	}
    }
...
extern "C"
#endif
XS(boot_ex__lib__zip); /* prototype to pass -Wmissing-prototypes */
XS(boot_ex__lib__zip)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("ex::lib::zip::new", XS_ex__lib__zip_new, file, "$$");
        newXSproto("ex::lib::zip::name", XS_ex__lib__zip_name, file, "$");
        newXSproto("ex::lib::zip::INC", XS_ex__lib__zip_INC, file, "$$");
    if (PL_unitcheckav)
